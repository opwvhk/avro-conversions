...
public final class IdlUtils {
    ...
    public static void writeIdlProtocol(final String protocolNameSpace, final String protocolName,
                                        final Writer writer, final Schema... schemas) throws IOException {
    ...
    private static void writeSchema(Schema schema, final Writer writer, JsonGenerator jsonGen,
    ...
    private static void writeFieldSchema(final Schema schema,
                                         final Writer writer, final JsonGenerator jsonGen,
    ...
    private static void writeSchemaAttributes(final Schema schema, final Writer writer, final JsonGenerator jsonGen)
            throws IOException {
    ...
    private static void writeJsonProperties(final JsonProperties props,
                                            final Writer writer, final JsonGenerator jsonGen, final boolean crBetween) throws IOException {
        writeJsonProperties(props, Collections.emptySet(), writer, jsonGen, crBetween);
    }

    private static void writeJsonProperties(final JsonProperties props, final Set<String> propertiesToSkip,
                                            final Writer writer, final JsonGenerator jsonGen, final boolean crBetween) throws IOException {
